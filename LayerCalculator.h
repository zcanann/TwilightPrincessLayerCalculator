...
// Modified getLayerNo_common_common function for improved readability. May contain errors, always cross-reference with original!
int getLayerId(Stage stage, int roomId, int layerOverride)
{
	...
	if (dKy_darkworld_stage_check(stage, roomId))
	{
		chosenLayer = 0xE;
	}
