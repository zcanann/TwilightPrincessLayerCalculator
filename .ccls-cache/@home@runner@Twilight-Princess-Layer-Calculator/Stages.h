...
const char* getStageId(const Stage stage)
{
	...
	case Stage::D_MN06A_Armogohma: return ;
	case Stage::D_MN06B_Darknut: return ;
	case Stage::D_MN07_City_in_the_Sky: return ;
	case Stage::D_MN07A_Argorok: return ;
	case Stage::D_MN07B_Aeralfos: return ;
	case Stage::D_MN08_Palace_of_Twilight: return ;
	case Stage::D_MN08A_Zant_Main_Room: return ;
	case Stage::D_MN08B_Phantom_Zant_1: return ;
	case Stage::D_MN08C_Phantom_Zant_2: return ;
	case Stage::D_MN08D_Zant_Fight: return ;
	case Stage::D_MN09_Hyrule_Castle: return ;
	case Stage::D_MN09A_Ganondorf_Castle: return ;
	case Stage::D_MN09B_Ganondorf_Field: return ;
	case Stage::D_MN09C_Ganondorf_Defeated: return ;
	case Stage::D_MN10_Arbiters_Grounds: return ;
	case Stage::D_MN10A_Stallord: return ;
	case Stage::D_MN10B_Death_Sword: return ;
	case Stage::D_MN11_Snowpeak_Ruins: return ;
	case Stage::D_MN11A_Blizzeta: return ;
	case Stage::D_MN11B_Darkhammer: return ;
	case Stage::D_SB00_Lanayru_Ice_Puzzle_Cave: return ;
	case Stage::D_SB01_Cave_of_Ordeals: return ;
	case Stage::D_SB02_Eldin_Long_Cave: return ;
	case Stage::D_SB03_Lake_Hylia_Long_Cave: return ;
	case Stage::D_SB04_Eldin_Goron_Stockcave: return ;
	case Stage::D_SB05_Grotto_1: return ;
	case Stage::D_SB06_Grotto_2: return ;
	case Stage::D_SB07_Grotto_3: return ;
	case Stage::D_SB08_Grotto_4: return ;
	case Stage::D_SB09_Grotto_5: return ;
	case Stage::D_SB10_Faron_Woods_Cave: return ;
	case Stage::F_SP00_Ordon_Ranch: return ;
	case Stage::F_SP102_Title_Screen: return ;
	case Stage::F_SP103_Ordon_Village: return ;
	case Stage::F_SP104_Ordon_Spring: return ;
	case Stage::F_SP108_Faron_Woods: return ;
	case Stage::F_SP109_Kakariko_Village: return ;
	case Stage::F_SP110_Death_Mountain: return ;
	case Stage::F_SP111_Kakariko_Graveyard: return ;
	case Stage::F_SP112_Zoras_River: return ;
	case Stage::F_SP113_Zoras_Domain: return ;
	case Stage::F_SP114_Snowpeak: return ;
	case Stage::F_SP115_Lake_Hylia: return ;
	case Stage::F_SP116_Castle_Town: return ;
	case Stage::F_SP117_Sacred_Grove: return ;
	case Stage::F_SP118_Bublin_Camp: return ;
	case Stage::F_SP121_Hyrule_Field: return ;
	case Stage::F_SP122_Outside_Castle_Town: return ;
	case Stage::F_SP123_Bublin_2: return ;
	case Stage::F_SP124_Gerudo_Desert: return ;
	case Stage::F_SP125_Mirror_Chamber: return ;
	case Stage::F_SP126_Upper_Zoras_River: return ;
	case Stage::F_SP127_Fishing_Pond: return ;
	case Stage::F_SP128_Hidden_Village: return ;
	case Stage::F_SP200_Hidden_Skill: return ;
	case Stage::R_SP01_Ordon_Village: return ;
	case Stage::R_SP107_Hyrule_Castle_Sewers: return ;
	case Stage::R_SP108_Faron_Woods: return ;
	case Stage::R_SP109_Kakariko_Village: return ;
	case Stage::R_SP110_Death_Mountain: return ;
	case Stage::R_SP115_Lake_Hylia: return ;
	case Stage::R_SP116_Telmas_Bar: return ;
	case Stage::R_SP127_Fishing_Pond: return ;
	case Stage::R_SP128_Hidden_Village: return ;
	case Stage::R_SP160_Castle_Town: return ;
	case Stage::R_SP161_Star_Game: return ;
	case Stage::R_SP209_Kakariko_Graveyard: return ;
	case Stage::R_SP300_Light_Arrows_Cutscene: return ;
	case Stage::R_SP301_Hyrule_Castle_Cutscenes: return ;
	case Stage::S_MV000_TP_Trailer: return ;
